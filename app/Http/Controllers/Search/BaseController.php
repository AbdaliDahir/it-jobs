...
class BaseController extends FrontController
{
	...
	public function commonQueries()
	{
		...
		$popCatId = (isset($this->cat->parent, $this->cat->parent->parent) && !empty($this->cat->parent->parent))
			? $this->cat->parent->parent->id
			: ((isset($this->cat->parent) && !empty($this->cat->parent)) ? $this->cat->parent->id : null);
