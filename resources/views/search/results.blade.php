		...
		<div class="row">
			...
			<div class="col-md-9 page-content col-thin-left">
				<div class="category-list">
					<div class="tab-box clearfix">
								...
								<li>
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											@if (isset($city, $distanceRange) and !empty($city) and
											!empty($distanceRange))
						...
						<div class="tab-filter hide-xs">
							<select id="orderBy" class="niceselecter select-sort-by" data-style="btn-select"
								data-width="auto">
								<option
									value="{!! qsUrl(request()->url(), request()->except(['orderBy', 'distance']), null, false) !!}">
									{{ t('Sort by') }}</option>
								@if (request()->filled('q'))
				...
				<div class="post-promo text-center">
					...
					<a href="{{ \App\Helpers\UrlGen::register() . '?type=2' }}"
						class="btn btn-border btn-post btn-add-listing">
