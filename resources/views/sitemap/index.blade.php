								...
								<div class="inner">
									<h2>
										<span class="title-3"><span
												style="font-weight: bold;">{{ t('List of Categories and Sub-categories') }}</span></span>
									</h2>
								</div>
							</div>
								...
								<div class="inner">
									<h2>
										<span class="title-3" style="font-weight: bold;">
											<i class="icon-location-2"></i> {{ t('List of Cities in') }}
											{{ config('country.name') }}
										</span>
									</h2>
								</div>
							...
							<div class="col-xl-12">
								<div class="list-categories-children">
									<div class="row">
										...
										<ul
											class="cat-list col-lg-3 col-md-4 col-sm-6 {{ ($cities->count() == $key+1) ? 'cat-list-border' : '' }}">
