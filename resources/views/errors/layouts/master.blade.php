...
<body class="{{ config('settings.style.app_skin') }}">
	...
	<div id="wrapper">
		...
		@section('header')
		@includeFirst([config('larapen.core.customizedViewPath') . 'errors.layouts.inc.header',
		'errors.layouts.inc.header'])
		@show
		...
		@section('footer')
		@includeFirst([config('larapen.core.customizedViewPath') . 'errors.layouts.inc.footer',
		'errors.layouts.inc.footer'])
		@show
