...
return [
    ...
    'setup' => 'Setup',
    'finish' => 'Finish',
	'cron_jobs_guide' => 'Insert the command line below to your system crontab.<br>NOTE: Below timings for running the cron jobs are the recommended, you can change it if you want.',
